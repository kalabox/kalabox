...
var DEV_CONFIG_FILENAME = 'development.json';
exports.DEV_CONFIG_FILENAME = DEV_CONFIG_FILENAME;

var DEFAULT_GLOBAL_CONFIG = {
  domain: 'kbox',
  engine: 'kalabox-engine-docker@0.10.7',
  engineRepo: 'kalabox',
  codeDir: 'code',
...
exports.getAppConfig = function(app, appRoot) {
  ...
  appConfigOverride('appCidsRoot', ':sysConfRoot:' + path.sep + 'appcids');
