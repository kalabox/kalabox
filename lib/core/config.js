...
var DEFAULT_GLOBAL_CONFIG = {
  domain: 'kbox',
  engine: 'https://github.com/kalabox/kalabox-engine-docker/' +
    'tarball/v0.8.0-beta',
  engineRepo: 'kalabox',
  codeDir: 'code',
  services: 'https://github.com/kalabox/kalabox-services-kalabox/' +
    'tarball/v0.8.0-beta',
  apps: [
    'https://github.com/kalabox/kalabox-app-backdrop/tarball/v0.8.0-beta',
    'https://github.com/kalabox/kalabox-app-drupal/tarball/v0.8.0-beta'
  ],
  profile: 'standard',
  sharing: true,
