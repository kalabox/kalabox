...
var DEFAULT_GLOBAL_CONFIG = {
  ...
  engine: 'kalabox-engine-docker@https://github.com/kalabox/' +
    'kalabox-engine-docker/tarball/elton-rocketman',
  engineRepo: 'kalabox',
  codeDir: 'code',
  services: 'kalabox-services-docker@https://github.com/kalabox/' +
    'kalabox-services-docker/tarball/elton-rocketman',
  apps: [
    'kalabox-app-backdrop@https://github.com/kalabox/' +
      'kalabox-app-backdrop/tarball/elton-rocketman',
    'kalabox-app-drupal@https://github.com/kalabox/' +
      'kalabox-app-drupal/tarball/elton-rocketman',
