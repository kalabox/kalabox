...
// @todo: bcauldwell - maybe move this to kbox.cli?
// @todo: bcauldwell - Promisify this library.
 ...
 */
var getMenu = exports.getMenu = function(branch, category, appName) {
...
var showMenu = exports.showMenu = function(branch, app) {
  ...
  validCategories.forEach(function(category) {
    ...
    if (category === 'dev' && globalConfig.devMode === true) {
