 ...
 */
var create = exports.create = function(name, config) {
  var app = {};
  app.name = name;
...
var installComponent = function(events, app, component, callback) {
  ...
  console.log('installOptions: ' + JSON.stringify(component.installOptions));
...
var getStartOptions = function(app, component, opts) {
  // @todo: this whole thing is unbelievably janksauce
  var bind = app.root;
  if (process.platform === 'win32') {
    bind = app.root.replace(/\\/g, '/').replace('C:/', '/c/');
  }
  else if (process.platform === 'linux')  {
    bind = app.root.replace('/home', '/Users');
  }
  var startOpts = {
