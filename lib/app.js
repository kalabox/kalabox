...
if (!fs.existsSync(config.appDataPath)) {
  fs.mkdirSync(config.appDataPath);
}
...
var App = function(apppath) {
  ...
  this.config.dataPath = path.resolve(config.appDataPath, this.appname);
  ...
  this.kalaboxPath = path.resolve(config.appDataPath, this.appname);
