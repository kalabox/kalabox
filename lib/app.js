...
var install = exports.install = function(app, callback)  {
  ...
  // See what we have in our appRegistry
  /*
  .then(function() {
    return disco.getDirsAppRegistry();
  })
  .then(function(regDirs) {
    console.log("REGISTRY SAYSSS");
    console.log(regDirs);
  })
*/
  // Emit pre event.
...
var destroy = exports.destroy = function(app, callback) {
  ...
  .then(function() {
    var dataContainerIdFile = path.join(app.config.appCidsRoot, 'data');
    // Try to read file.
