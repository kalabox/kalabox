 ...
 * and removed.
 */
exports.use = function(image, createOpts, startOpts, fn, callback) {
 ...
 */
exports.query = function(cid, cmd, callback) {
 ...
 * Run a query against a container.
 */
exports.queryData = function(cid, cmd, callback) {
 ...
 */
exports.terminal = function(cid, callback) {
 ...
 *
 */
exports.build = function(data, opts, callback) {

  // Verify provider is ready.
  return verifyProviderIsReady()
  // Build image.
  .then(function() {
    return engineInstance().call('build', data, opts);
  })
  // Return.
  .nodeify(callback);
