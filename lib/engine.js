...
/**
 * Builds the image for a container.
 * @arg {string} image - Name of the image to build.
...
exports.build = function(image, callback) {
  docker.build(image, callback);
};

/**
 * Pulls the image for a container.
 * @arg {string} image - Name of the image to pull.
 * @arg {function} callback - callback(err, data) - Callback called when the image has been pulled.
 */
