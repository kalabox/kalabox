...
var services = require('./engine/services.js');
var provider = require('./engine/provider.js');
//@todo: ideally we dont want to export this
 ...
 */
var build = function(images, callback) {
  verifyProvider(function(err) {
    if (err) {
      callback(err);
    } else {
      ...
      engine[fn + many](images, callback);
    }
  });
};
exports.build = build;
 ...
 * @arg {function} callback - callback(err, data) - Callback called when the image has been built.
 */
exports.services.init = function(callback) {
  callback(null);
};
 ...
 * @arg {function} callback - callback(err, data) - Callback called when the image has been built.
 */
exports.services.install = function(callback) {
  helpers.mapAsync(
    services.getCoreImages(),
