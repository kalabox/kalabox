 ...
 * });
 */
exports.list = exports.listContainers = function(data, callback) {
...
exports.isRunning = exports.isContainerRunning = function(data, callback) {
 ...
 *  });
 */
exports.exists = exports.containerExists = function(data, callback) {
...
exports.info = function(data, callback) {
  ...
  .then(function() {
    return engineInstance().call('info', data);
  })
  // Return.
  .nodeify(callback);
...
/**
 * Creates a container or containers.
 * @arg {object} data [optional] - Object containing the create data for the container(s).
...
exports.create = function(data, callback) {
  ...
  .then(function() {
    return core.events.emit('pre-engine-create', data);
  })
  // Create container.
  .then(function() {
    return engineInstance().call('create', data);
  })
  // Emit post engine create event.
  .then(function() {
    return core.events.emit('post-engine-create', data);
  })
  // Return.
  .nodeify(callback);
...
/**
 * Uses a container.
 * @arg {string} data - Data about the container to use.
 * @arg {function} callback - Callback called when the container has been started.
 * @arg {error} callback.error
 * @todo Find a good way to document data, and possibly not make them docker specific.
 * @example
 * engine.start(component.containerId, function(err) {
 *   if (err) {
 *     callback(err);
...
exports.use = function(data, callback) {
  ...
  // Verify provider is ready.
  return verifyProviderIsReady()
  // Emit pre engine use event.
  .then(function() {
    return core.events.emit('pre-engine-use', data);
  })
  // Call use on engine.
  .then(function() {
    return engineInstance().call('use', data);
  })
  // Emit post engine use event.
  .then(function() {
    return core.events.emit('post-engine-use', data);
  })
  // Return.
  .nodeify(callback);
...
exports.query = function(data, callback) {
  ...
  // Query.
  .then(function() {
    return engineInstance().call('query', data);
  })
  // Return.
  .nodeify(callback);
 ...
 * Run a query against a container.
 */
exports.queryData = function(data, callback) {

  // Verify provider is ready.
  return verifyProviderIsReady()
  // Query for data.
  .then(function() {
    return engineInstance().call('queryData', data);
  })
  // Return.
  .nodeify(callback);
 ...
 * @arg {string} data - Data to ID the container to attach.
 */
exports.terminal = function(data, callback) {

  // Verify provider is ready.
  return verifyProviderIsReady()
  // Terminal into container.
  .then(function() {
    return engineInstance().call('terminal', data);
  })
  // Return.
  .nodeify(callback);
...
exports.remove = function(data, callback) {
  ...
  .then(function() {
    return core.events.emit('pre-engine-remove', data);
  })
  // Remove container.
  .then(function() {
    return engineInstance().call('remove', data);
  })
  // Emit post engine remove event.
  .then(function() {
    return core.events.emit('post-engine-remove', data);
  })
  // Return.
  .nodeify(callback);
...
exports.logs = function(data, callback) {

  // Verify provider is ready.
  return verifyProviderIsReady()
  // Query container's logs.
  .then(function() {
    return engineInstance().call('logs', data);
  })
  // Return.
  .nodeify(callback);
 ...
 * })
 *
 * kbox.engine.build({id: 'syncthing', dirs: composeDirs}, function(err) {
 *   if (err) {
 *     state.status = false;
 *     done(err);
 *   } else {
