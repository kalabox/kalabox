...
module.exports = function() {
  ...
  var createApp = function(protoApp, results, callback) {
    ...
    .then(function() {
      kbox.status.update('Starting engine.');
    ...
    .then(function() {
      ...
      .tap(function(app) {
        kbox.status.update('Starting app.');
    ...
    .tap(function(app) {
      kbox.status.update('Running post create tasks.');
    ...
    // Print message
    .then(function(app) {
      console.log(kbox.art.postCreate(app));
    })
