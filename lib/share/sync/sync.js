 ...
 */
Sync.prototype.ping = function(opts) {
  var self = this;
  logDebug('SYNC => PING ' + self.address);
  return rest.ping(self.address, opts);
};

/*
 * Ping the syncthing instance using an older version of the API.
 */
Sync.prototype.pingVersion10 = function(opts) {
  logDebug('SYNC => PING ' + this.address);
  return rest.pingVersion10(this.address, opts);
};
