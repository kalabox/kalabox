...
module.exports = function(kbox) {
  ...
  /*
   * Standard interface action for logins.
   */
  Integration.prototype.logins = function() {
    return this.action('logins');
  };
  ...
  /*
   * Standard interface action for push.
   */
  Integration.prototype.push = function() {
