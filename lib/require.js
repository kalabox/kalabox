...
var requireFromNodeModulesAndOtherDirs =
  function(parentModule, kbox, id, callback) {
  ...
  .then(function(mod) {
    if (mod) {
      ...
      return requireFromOtherDirs(kbox, id);
    }
  })
  // Return.
  .nodeify(callback);
 ...
 * different places.
 */
var requireModule = function(parentModule, kbox, id, callback) {
  ...
  // Try to load module.
  return requireFromNodeModulesAndOtherDirs(parentModule, kbox, pkg)
  // Return.
  .nodeify(callback);
 ...
 */
var requireInternal = function(parentModule, kbox, id, callback) {

  // Try to load the module.
  return requireModule(parentModule, kbox, id)
 ...
 */
exports.require = function(parentModule, kbox, id, callback) {
  ...
  .then(function(mod) {
    if (mod) {
      ...
      return requireInternal(parentModule, kbox, id);
    }
  })
