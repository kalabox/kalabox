...
var requireFromNodeModules = function(id, callback) {
  ...
  return Promise.try(function() {
    return module.parent.parent.require(id);
  })
...
var requireFromOtherDirs = function(kbox, id, callback) {
  ...
  return Promise.filter(paths, fs.existsAsync)
  .all()
...
var requireFromNodeModulesAndOtherDirs = function(kbox, id, callback) {
  ...
  return requireFromNodeModules(id)
...
var requireModule = function(kbox, id, callback) {
  ...
  // Try to load module.
  return requireFromNodeModulesAndOtherDirs(kbox, pkg)
  // Return.
  .nodeify(callback);
...
exports.require = function(kbox, id, callback) {
  ...
  .then(function(mod) {
    if (mod) {
      ...
      return requireInternal(kbox, id);
    }
  })
