...
var kboxEnv = require('./kboxEnv.js');
...
var getGlobalConfigFilepath = function() {
  return path.join(kboxEnv.getKalaboxRoot(), CONFIG_FILENAME);
};
...
module.exports.getGlobalConfig = function() {
  ...
  var globalConfigFile = loadConfigFile(getGlobalConfigFilepath());
