...
var run = exports.run = function(image, cmd, streamIn, streamOut, createOptions, startOptions, callback) {
  var opts = {
    Hostname: '',
    User: '',
    AttachStdin: true,
...
// @todo: document
var query = exports.query = function(image, cmd, createOptions, startOptions, callback, done) {
  var opts = {
    Hostname: '',
    User: '',
    AttachStdin: false,
