...
var getStartupServices = function(startupConf) {
  var servicePrefix = deps.lookup('globalConfig').startupServicePrefix;
  var services = {};
...
var start = function(app, done) {
  ...
  var services = getStartupServices(deps.lookup('globalConfig').startupServices);
  var filters = {
    name: [deps.lookup('globalConfig').startupServicePrefix]
  };
  var opts = {
    all : 1,
...
var loadPlugins = function() {
  deps.call(function(globalConfig) {
    ...
    globalConfig.globalPlugins.forEach(function(pluginName) {
      var plugin = _plugin.loadIfDoesNotUseApp(pluginName, pluginDirs);
      if (plugin !== null) {
