...
// @todo @document
exports.init = _.once(function(callback) {
...
/**
 * Destroys all the startable services and recreates them
 ...
 * @example
 * services.rebuild(function() {
 *   log.info('Core services rebuilt!.');
 *     next(null);
 *   });
 * }
 */
exports.rebuild = function(callback) {
  // Install.
  return servicesInstance().call('rebuild')
  // Return.
  .nodeify(callback);
};
